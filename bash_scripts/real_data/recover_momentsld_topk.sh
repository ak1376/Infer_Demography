...
#
# Usage:
#   bash bash_scripts/real_data/recover_momentsld_topk.sh              # all sim ids, top 5
#   TOP_K=3 bash bash_scripts/real_data/recover_momentsld_topk.sh       # different K
#   FORCE=1 bash bash_scripts/real_data/recover_momentsld_topk.sh       # overwrite existing best_fit.pkl too
#   SIDS="0 1 2" bash bash_scripts/real_data/recover_momentsld_topk.sh  # only these sim ids

#!/bin/bash
# bash_scripts/real_data/compare_real_fit_params.sh
#
...
#
# Usage:
#   bash bash_scripts/real_data/compare_real_fit_params.sh
#   VARIANT=w_FIM_w_SFSresids MODEL_KEY=random_forest bash bash_scripts/real_data/compare_real_fit_params.sh

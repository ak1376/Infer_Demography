...
1. Load the real Drosophila polarized VCF -> SNP positions + per-population
   allele counts.
2. Partition the chromosome into `n_windows` equal-width, non-overlapping
   windows.
...
CLI wrapper: godambe_correction_LRT/snakemake_scripts/windowed_summary_statistics.py
"""
